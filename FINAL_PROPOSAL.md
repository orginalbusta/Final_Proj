...
**Project Title:** Echoes of History: An Interactive Exploration of Human Development (1960-2020)
...
This dataset contains pre-cleaned World Bank data tracking 250+ countries across 20 development indicators (climate change, economy, education, health, infrastructure, poverty, etc.) from 1960-2020. Each indicator file contains 10,000+ rows and 50+ columns of real-world data.
...
Two-panel visualization showing GDP growth for major economies (United States, China, Germany, Japan, India, Brazil). Left panel displays absolute GDP in trillions (constant 2010 US$), while right panel shows indexed growth rates on log scale. Reveals dramatic shifts in global economic power, particularly China's exponential growth.

### Visualization 2: Health & Demographic Indicators by Region
![Health Indicators](visualizations/02_life_expectancy.png)

Regional comparison of demographic and health metrics across North America, Europe, East Asia, South Asia, Africa, and Latin America from 1960-2020, illustrating global health convergence and persistent disparities.

### Visualization 3: Mobile Phone Penetration Growth
![Mobile Penetration](visualizations/03_education_progress.png)

Multi-line time series showing mobile cellular subscriptions per 100 people for United States, South Korea, China, India, Brazil, and Nigeria. Visualizes the rapid digital revolution from the 1990s onwards, with some nations achieving over 100% penetration (multiple devices per person).

### Visualization 4: Population Growth Trends
![Population Growth](visualizations/04_poverty_decline.png)

Annual population growth rates for major developing nations (China, India, Brazil, Nigeria, Bangladesh, Mexico), revealing demographic transitions from rapid growth in the 1960s-1980s to declining rates as nations modernize.

### Visualization 5: Climate & CO₂ Emissions
![Climate Emissions](visualizations/05_climate_emissions.png)

Comparison of CO₂ emissions and climate metrics across major economies (United States, China, Germany, India, Brazil, Saudi Arabia), revealing environmental costs of industrialization and recent sustainability efforts.
...
Two-panel visualization showing broadband/internet infrastructure growth trends (2000-2020) and current digital access comparison across diverse economies, demonstrating the persistent digital divide.
